...
// ------------------------------------ methods ------------------------------------------------
    ...
    public void makeGraph(int verticesNo, int edgeNo){
        ...
        for (int i = 0; i < verticesNo; i++){
           ...
           // called the createVertex to crate an offece object , then add it to the vertices list 
            vertices.add(createVertex(label,false));
         // second set the label with "O" +i  start with O1 to On . where n = number of node 
        ...
        for (int i = 0; i < verticesNo-1; i++) {
            ...
            // generate random edge weights between 1-20 that mean the length of line is equal to 5-100
        ...
        while (remEdges>0){
            ...
            if (sourceVertex != targetVertex && !isConnected(sourceVertex, targetVertex)) {
                ...
                // so the Length of line will be  between 5-100
                int randomWeight = random.nextInt(20) + 1;
    ...
    private boolean isConnected( Vertex source , Vertex target ) {
     ...
     /* abstract mithod to create object of office in the extends class which is blueprintgragh
    ...
    */
    ...
    /* abstract mithod to create object of line n the extends class which is blueprintgragh
    ...
    */
    ...
    /*read data from the file and creat the graph 
     * @param inputfile the file of graph
     * @return void 
    */
        ...
        do {
               // read from file
                ...
                if (v == null){ // if v not created yet
                    // call mithod createVertex to create a new office (vertix) 
    ...
    */
     ...
     /* void method to display the information of vertix (office)
